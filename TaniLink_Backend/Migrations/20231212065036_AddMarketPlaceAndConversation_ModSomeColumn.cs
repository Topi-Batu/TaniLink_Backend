...
{
    /// <inheritdoc />
    public partial class AddMarketPlaceAndConversation_ModSomeColumn : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FotoKtp = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NoRek = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FotoBuktab = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourierPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderShoppingCart", x => new { x.OrdersId, x.ShoppingCartId });
                    table.ForeignKey(
                        name: "FK_OrderShoppingCart_Orders_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderShoppingCart_ShoppingCarts_ShoppingCartId",
